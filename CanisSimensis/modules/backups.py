...
import CanisSimensis.modules.sql.notes_sql as sql
from CanisSimensis import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from CanisSimensis.__main__ import DATA_IMPORT
from CanisSimensis.modules.helper_funcs.chat_status import user_admin
from CanisSimensis.modules.helper_funcs.alternate import typing_action

# from CanisSimensis.modules.rules import get_rules
import CanisSimensis.modules.sql.rules_sql as rulessql

# from CanisSimensis.modules.sql import warns_sql as warnssql
import CanisSimensis.modules.sql.blacklist_sql as blacklistsql
from CanisSimensis.modules.sql import disable_sql as disabledsql

# from CanisSimensis.modules.sql import cust_filters_sql as filtersql
# import CanisSimensis.modules.sql.welcome_sql as welcsql
import CanisSimensis.modules.sql.locks_sql as locksql
from CanisSimensis.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("CanisSimensis{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("CanisSimensis{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `CanisSimensis-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl,
        ),
        timeout=360,
    ...
    os.remove("CanisSimensis{}.backup".format(chat_id))  # Cleaning file
