...
import CanisSimensis.modules.sql.global_bans_sql as gban_sql
import CanisSimensis.modules.sql.users_sql as user_sql
from CanisSimensis import DEV_USERS, OWNER_ID, dispatcher
