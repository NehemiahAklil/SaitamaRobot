...
def get_user_list(config, key):
    with open("{}/CanisSimensis/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    # RECOMMENDED
    # needed for any database modules # its "URI" and not "URL" as herok and similar ones only accept it as such
