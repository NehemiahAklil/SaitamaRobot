...
from CanisSimensis.modules import ALL_MODULES
from CanisSimensis.modules.helper_funcs.chat_status import is_user_admin
from CanisSimensis.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(
        "CanisSimensis.modules." + module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            ...
                            InlineKeyboardButton(
                                text="🗄 Source code",
                                url="https://github.com/NehemiahAklil/CanisSimensis",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
    ...
    try:
        if mod_match:
            ...
            text = "*{}* has the following settings for the *{}* module:\n\n".format(
                escape_markdown(
                    chat.title), CHAT_SETTINGS[module].__mod_name__,
